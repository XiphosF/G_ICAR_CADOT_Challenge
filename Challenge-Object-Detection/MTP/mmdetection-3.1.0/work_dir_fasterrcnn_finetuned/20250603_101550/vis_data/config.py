...
model = dict(
    backbone=dict(
        ...
        patch_size=16,
        pretrained=
        '/home/fourret/ICIP_challenge/MTP/last_vit_l_rvsa_ss_is_rd_pretrn_model.pth',
        qk_scale=None,
        qkv_bias=True,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        test_mode=True,
        type='ICIPChallengeDataset'),
    drop_last=False,
    num_workers=8,
    persistent_workers=True,
    sampler=dict(shuffle=False, type='DefaultSampler'))
test_evaluator = dict(
    ann_file='/data/fourret/ICIP_Challenge/valid/_annotations.coco.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
work_dir = '../RS_Tasks_Finetune/Horizontal_Detection/work_dirs_from_pretrained_final/'
